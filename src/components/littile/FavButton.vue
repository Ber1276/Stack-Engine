    ...
    <div>
        <div class="circle " @click="handleClick" :class="isUp ? 'check' : ''">
            <div class="img-box" :class="isUp ? 'img-box-check' : ''">
                <svg v-if="isUp" t="1727019984174" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="3011" width="24" height="24">
                    <path
                        ...
                        fill="#d81e06" p-id="3012"></path>
                </svg>
                <svg v-else t="1727019957578" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="2864" width="24" height="24">
                    <path
